...
const points = [
  {
    ...
    label: '浩富聯合會計師事務所',
    img: '浩富Logo.png',
    desc: '浩富聯合會計師事務所專注於 高淨值個人與家族企業的全方位財稅整合服務，結合專業的會計、稅務、法務與投資架構規劃，協助客戶在日益複雜的國際環境中，實現 財富保全與世代傳承的長遠目標。我們的核心團隊擁有四大會計師事務所與跨國稅務規劃的豐富經驗，深耕於個人稅務規劃、家族資產傳承及跨境投資架構設計，並首創 「7P1A」財富傳承理念。透過量身訂製的傳承方案，我們協助客戶有效管理財務風險、優化稅務策略，並確保每一筆資產的價值能安全且穩健地傳遞至下一代。'
  },
  {
    id: 'point_B',
    cx: 763,
  ...
  },
  {
    ...
    label: '浩信聯合會計師事務所',
    img: '浩信Logo.png',
    desc: '浩信聯合會計師事務所是大信國際的成員所，由多名執業會計師帶領，並結合財務、稅務、會計等專業領域人才所組成的優質團隊，本所會計師擁有豐富的兩岸工作及IPO經驗，能提供境內外企業（包含受控外國企業CFC等）在會計帳務處理、財務稅務審計、稅務規劃及申報、工商變更、薪資委外、內部控制及會計制度建立等相關諮詢服務，以全力協助客戶應對日趨競爭且多變的全球化市場，並提供更多元及可靠的會計相關服務。 '
  }
];

{
  /*
  這是陣列裡的資料若未來要家回來可直接貼上去
    {
    id: 'point_D',
    cx: 777,
    cy: 298,
